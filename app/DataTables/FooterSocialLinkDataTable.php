    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                return '<a href="' . route('admin.footer-social.edit', $query->id) . '" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                       <a href="' . route('admin.footer-social.destroy', $query->id) . '" class="btn btn-sm btn-danger delete-item"><i class="fas fa-trash"></i></a>';
            })
